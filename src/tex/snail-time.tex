...
The challenge of quantitatively matching the local phase-space spiral properties with simulations has motivated mapping the vertical spiral and its properties throughout larger observable portions of the Milky Way disk \citep[e.g.,][]{XX}. % TODO: LAMOST paper, Antoja DR3 paper
