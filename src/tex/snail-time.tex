...
% Outline: Gaia discovery of phase-space spiral. Initial interpretation papers (Laporte, Bland-Hawthorn) and connection to global kinematics (Katz). But any spatial selection contains many overlapping spirals because Dynamics.
